                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="nama" placeholder="Nama Product" required>
                    </div>
                  </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="deskripsi" placeholder="Deskripsi Product" required>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="example-text-input" class="form-control-label">Harga</label>
                      <input class="form-control" type="number" name="harga" placeholder="Rp.123456" required>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="example-text-input" class="form-control-label">Stok</label>
                      <input class="form-control" type="number" name="stok" placeholder="Rp.123456" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <ul class="nav nav-pills nav-fill p-1">
                  <li class="nav-item">
                    <button class="nav-link mb-0 px-0 py-1 active d-flex align-items-center justify-content-center " data-bs-toggle="tab" type="submit">
                      <i class="ni ni-app"></i>
                      <span class="ms-2">Tambah Product</span>
                    </button>
                  </li>
                </ul>
              </div>
